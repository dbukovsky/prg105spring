...
def joke():
    print("What do diapers and politicians have in common?")
    print("They should both be changed frequently, for the same reasons. ")
...
def joke5():
    print("Wow I didn't know you yodel.")
...
print(math.ciel(number_to_round))
