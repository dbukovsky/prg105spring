...
birthdays = {'Meri': 'May 16', 'Kathy': 'July 14', 'Dylan': 'February 18', 'Henry': 'July 5', 'Tyler': 'October 18'}

# 2) Print Meri's Birthday
print("Meri's birthday is: ")
...
if "Mon" in days:
    print("Yes, Mon is in days")
else:
    print("No, Mon is not in days")
...
outputfile = open("my_data.dat", "wb")
