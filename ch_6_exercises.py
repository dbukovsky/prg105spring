...
state_capitals.write("Springfield, IL\n")
state_capitals.write("Sacramento, CA\n")
state_capitals.write("Madison, WI\n")
...
for book in range(0, books):
    my_book = input("Please enter the title and author of a book:  ")
    books_file.write(my_book + "\n")
